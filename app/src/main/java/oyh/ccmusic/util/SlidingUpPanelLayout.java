...
public class SlidingUpPanelLayout extends ViewGroup {
    ...
    private boolean mIsSaveStateEnabled = true;
    ...
    /**
     *  Should sliding of this view be limited to the anchor View
     */
    private boolean mLimitSlideOnAnchor = false;
    ...
    //[BUGFIX]Add by TCTNJ, wenzhou for PR1208072 begin
    private boolean dragingOnBack;
    private Runnable collapeSliderView = new Runnable() {
        @Override
        public void run() {
            collapsePanel();
            setDragingOnBackState(false);
        }
    };
    //[BUGFIX]Add by TCTNJ, wenzhou for PR1208072 end
    ...
    public void setDragingOnBackState(boolean state)
    {
        dragingOnBack =  state;
    }
    ...
    public SlidingUpPanelLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            ...
            if (ta != null) {
                ...
                mLimitSlideOnAnchor = ta.getBoolean(R.styleable.SlidingUpPanelLayout_limitSlideOnAnchor, false);
...
//    protected boolean doesRecyclerViewIsHandlingTouch(int x, int y)
//    {
//    	mRecyclerView = (RecyclerView) findViewById(R.id.recycler_view);
//    		if(mRecyclerView == null || mRecyclerView.getVisibility() != View.VISIBLE)
//    			return false;
//    	    int[] viewLocation = new int[2];
//    	    mRecyclerView.getLocationOnScreen(viewLocation);
//    	    int[] parentLocation = new int[2];
//    	    this.getLocationOnScreen(parentLocation);
//    	    int screenX = parentLocation[0] + x;
//    	    int screenY = parentLocation[1] + y;
//    	    return screenX >= viewLocation[0] && 
//    	           screenX < viewLocation[0] + mRecyclerView.getWidth() && 
//    	           screenY >= viewLocation[1] && 
//    	           screenY < viewLocation[1] + mRecyclerView.getHeight();
//    }
        ...
        if (mDragView != null) {
            ...
            mDragView.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    if (!isEnabled() /*|| !mIsUnableToDrag*/) 		// TODO : @Nordhal : I remove this to be able to click on the bar
                    	return;
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            //[BUGFIX] -Modify by TCTNJ-liang.guo,PR1059108, 2015-08-04 Begin
            try{
            ...
            //[BUGFIX] -Modify by TCTNJ-liang.guo,PR1059108, 2015-08-04 End
        }
...
//        if (doesRecyclerViewIsHandlingTouch((int) x, (int) y))
//        	return false;
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN: {
            	if (mLimitSlideOnAnchor)
            	{
            		if ((y <= mPanelHeight && isPanelExpanded()) ||
            			 (y >= getHeight() - mPanelHeight && !isPanelExpanded()))
            		{
    ...
    public void hidePanel() {
        if (mFirstLayout) {
            ...
            if (mSlideState == PanelState.DRAGGING /*|| mSlideState == PanelState.HIDDEN*/) return;//[bugfix] -remove judgement by TCTNJ-zhongrui.guo1,PR997784,2015-05-28
            int newTop = computePanelTopPosition(0.0f) + (mIsSlidingUp ? +mPanelHeight : -mPanelHeight);
    ...
    public void setSavedStateEnabled(boolean isSaveStateEnabled)
    {
    	mIsSaveStateEnabled = isSaveStateEnabled;
    }
            ...
            if (mDragHelper.getViewDragState() == ViewDragHelper.STATE_IDLE) {
                ...
                if (mSlideOffset == 1) {
                    if (mSlideState != PanelState.EXPANDED) {
                        ...
                        if(dragingOnBack)
                        {
                            mSlideableView.post(collapeSliderView);
                        }
                        //[BUGFIX]Add by TCTNJ, wenzhou for PR1208072 end
                    }
