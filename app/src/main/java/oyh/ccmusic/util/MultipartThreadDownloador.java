...
/**
 * Created by yihong.ou on 17-10-13.
 */
...
//            this.fileSize = (long) MusicUtils.get(AppliContext.sContext,"filesize",0);// 根据响应获取文件大小
            ...
            Log.e("MultipartThreadDownloador","需要下载的文件大小为 :" + this.fileSize + " 存储位置为： "
                    + dirStr + "/" + filename);
    ...
    private class DownloadThread extends Thread
    {
        ...
        public void run()
        {
            Log.e("MultipartThreadDownloador",Thread.currentThread().getName() + "开始下载...");
            try
            {
                ...
                if (conn.getResponseCode() == 206)
                {
                    ...
                    raf.close();
                    is.close();
                    Log.e("MultipartThreadDownloador",Thread.currentThread().getName()
